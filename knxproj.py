...
parser.add_argument("--knxproj", action="store", help="Exported KNX project file", required=True)
parser.add_argument("--knxd-ip", action="store", help="KNXD IP address", required=True)
parser.add_argument("--knxd-port", action="store", help="KNXD port", type=int, default="6720")
